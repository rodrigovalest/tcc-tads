          ...
          <View className="absolute left-0 right-0 bottom-0 flex justify-center items-center" style={{ top: 140 }}>
            <View className="bg-[#171717] w-[90%] rounded-2xl border-appBlack border-2 flex items-center justify-center">
              <View className="flex flex-col justify-center items-center w-full py-6">
                ...
                <View className='bg-[#167940] w-[70vw] h-[35vh] flex items-center justify-center rounded-xl mt-2 mb-2 py-2'>
                  <Text className="text-white text-lg font-nunito-bold">Animals</Text>
                </View>
                <Text className='text-white mb-4'>Adam is :</Text>
                <TouchableOpacity
                  className="bg-[#167940] p-4 rounded-full w-[70vw] mb-3"
                  onPress={() => console.log('Botão Verde pressionado')}
                >
                ...
                <TouchableOpacity
                  ...
                  onPress={() => console.log('Botão Vermelho pressionado')}
                >

...
import { ReceivedRequestCard } from '../../../components/friends/ReceivedRequestCard';
...
export default function RequestsReceivedScreen() {
  ...
  const {
    ...
    handleRefresh,
    respondToRequest
  } = useFriendshipRequests('received');
    ...
    if (requests.length === 0) {
      return (
        <EmptyState
          ...
          description={t('friends.noReceivedRequestsDescription')}
        />
      );
    }
  ...
  return (
    <View className="flex-1 bg-appBgWhite">
      <SafeAreaView className="flex-1 px-6 pt-6">
        <ScreenHeader title={t('friends.receivedRequests')} />

  ...
  return (
    <View className="bg-white rounded-xl p-5 mb-4 border border-appLightGrey shadow-sm">
      ...
      <View className="flex-row">
        ...
        {onInviteToGame && (
          <TouchableOpacity
            onPress={() => onInviteToGame(friendship.friend.id)}
            className="flex-1 bg-appYellow py-3 px-4 rounded-xl flex-row items-center justify-center mx-2 shadow-sm"
            activeOpacity={0.8}
          >
            <Ionicons name="game-controller" size={18} color={COLORS.appDarkGrey} />

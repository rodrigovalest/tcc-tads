...
jest.mock('@/hooks/useGameModes', () => ({
  useGameModes: (modes: GameMode[]) => ({
    columns: [modes.slice(0, Math.ceil(modes.length / 2)), modes.slice(Math.ceil(modes.length / 2))],
    columnWidth: 150,
  }),
}));

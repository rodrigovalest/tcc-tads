...
describe('FlagIcon', () => {
  ...
  it('should render with different sizes', () => {
    const { UNSAFE_root } = render(
      <FlagIcon countryCode="gb" size={32} />
    );
  ...
  it('should render Spanish flag icon', () => {
    const { UNSAFE_root } = render(
      <FlagIcon countryCode="es" size={24} />
    );
  ...
  it('should render with various size options', () => {
    ...
    sizes.forEach(size => {
      const { UNSAFE_root } = render(
        <FlagIcon countryCode="br" size={size} />
      );
  ...
  it('should render all supported flags', () => {
    ...
    supportedCodes.forEach(code => {
      const { UNSAFE_root } = render(
        <FlagIcon countryCode={code} size={24} />
      );
